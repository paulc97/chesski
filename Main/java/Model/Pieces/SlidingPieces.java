...
public class SlidingPieces {
    ...
    {
        long binaryS=1L<<s;
        long possibilitiesDiagonal = ((OCCUPIED& Diagonals[(s / 8) + (s % 8)]) - (2 * binaryS)) ^ Long.reverse(Long.reverse(OCCUPIED& Diagonals[(s / 8) + (s % 8)]) - (2 * Long.reverse(binaryS)));
        long possibilitiesAntiDiagonal = ((OCCUPIED& AntiDiagonals[(s / 8) + 7 - (s % 8)]) - (2 * binaryS)) ^ Long.reverse(Long.reverse(OCCUPIED& AntiDiagonals[(s / 8) + 7 - (s % 8)]) - (2 * Long.reverse(binaryS)));
    ...
    public static long HAndVMoves(int s,long OCCUPIED)
    {
        ...
        long possibilitiesVertical = ((OCCUPIED& Columns[s % 8]) - (2 * binaryS)) ^ Long.reverse(Long.reverse(OCCUPIED& Columns[s % 8]) - (2 * Long.reverse(binaryS)));
        return (possibilitiesHorizontal& Rows[s / 8]) | (possibilitiesVertical& Columns[s % 8]);
