...
@ClientEndpoint
public class GameserverPlayer2 {
    ...
    //Config
    private final String userName1 = "Player2";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            client.connectToServer(GameserverPlayer2.class, new URI("ws://localhost:8025/websockets/game"));
            latch.await();
