...
public class RemotePlayer1 {
    ...
    //Config
    private final String userName1 = "Player12343";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            client.connectToServer(RemotePlayer1.class, new URI("ws://chess.df1ash.de:8025/websockets/game"));
            latch.await();
