...
public class MoveTests {
    ...
    @Test
    void debugForumMives(){
        //assertEquals(2, moveGenerator.getMoveCount(moveGenerator.checkpawnMoves(new Board("r7/P1P5/p7/P4k2/n7/P1P2K2/1BP2PBN/1QR2R1n w - - 0 1")))); //TODO:Does not Check if Field is blocked
        //assertEquals(21, moveGenerator.getMoveCount(moveGenerator.checkKingMove(new Board("r3k2r/ppp1npbp/b3p1p1/8/8/4P3/PPP2PPP/R3K2R w KQkq - 0 1")))); //TODO: King does not check if Field is attacked. Does not check if he castles trough check.
    ...
    void ForumsMoves(){
        ...
        //assertEquals(16, moveGenerator.getMoveCount(moveGenerator.validMoves(new Board("r7/P1P5/p7/P4k2/n7/P1P2K2/1BP2PBN/1QR2R1n w - - 0 1"))));//TODO:CheckPawnMovetest
        ...
        //assertEquals(32, moveGenerator.getMoveCount(moveGenerator.validMoves(new Board("rnbqkb1r/ppp1pppp/5n2/3p4/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 2 1"))));
